...
const UsersPage = () => {
  ...
  const canAssignRole = (role: UserRole) => {
    ...
    if (currentUserRole === UserRole.Mentor && role !== UserRole.Mentor && role !== UserRole.ChiefOwner) {
      return true;
    }
    return false;
  };
  ...
  const canCreateTask = () => {
    return currentUserRole === UserRole.ChiefOwner || currentUserRole === UserRole.Mentor;
  };
  
  const canGrade = () => {
    return currentUserRole === UserRole.ChiefOwner || currentUserRole === UserRole.Mentor || currentUserRole === UserRole.Grader;
  };
